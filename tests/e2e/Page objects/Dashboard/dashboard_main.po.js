...
var mainPageObject = function () {
    var switchtolegacy = element(by.xpath('//div[@rp-model="$ctrl.model.appView"]'));
    this.get = function () {
        browser.get('');
    };
    ...
    this.actionsmenu = function (item) {
        element(by.cssContainingText('.rp-actions-menu-item', item)).click();
    }
